...
func set_damage_label(value: int, position: Vector2, is_critical: bool = false) -> void:
	...
	tween.tween_property(number, "position:y", number.position.y, 0.50).set_ease(Tween.EASE_IN).set_delay(0.25)
